...
def template_model(symvar_type='SX'):
    ...
    Power_solar_MS_par = model.set_variable('_p', 'Power_solar_MS_par')
    ...
    model.set_expression('Power_disca', (Power_solar- Power_elect - Power_charg)/1000)	
    ...
    model.set_expression('mol_produced',((V_dot_g_cath*P_out_hyd_cath)/(R*T))*20)
    ...
    model.set_expression('Power_disch_aux', Power_disch/1000)
    model.set_expression('Power_charg_aux', Power_charg/1000)
    model.set_expression('Power_elect_aux', Power_elect/1000)
    model.set_expression('Power_solar_aux', Power_solar/1000)
    model.set_expression('P_hyd_tank_aux', P_hyd_tank/101325)
    model.set_expression('Power_solar_scenario', Power_solar_MS_par*Power_solar)
