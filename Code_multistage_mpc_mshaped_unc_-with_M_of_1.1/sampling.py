...
plan = tools.load_pickle('./sampling_results_history/LiDo_results/20_360_runs/node_8_result/plan8.pkl')
...
def closed_loop(solar_power_baseline,solar_power_unc, demand_baseline, demand_unc):
    ...
    simulator = template_simulator(model,solar_power_unc, demand_baseline) #currently not considering demand uncertainty
...
def main():
    ...
    sampler.data_dir = './missing_results/'
    start_time = time.time()
