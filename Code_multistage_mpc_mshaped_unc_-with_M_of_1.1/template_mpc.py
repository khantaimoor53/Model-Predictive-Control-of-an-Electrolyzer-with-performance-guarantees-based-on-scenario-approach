...
def template_mpc(model, B_cap, p_ano, p_water, I, A_el, Volt_disch, Volt_charg, N_cell,solar_power_baseline, demand_baseline):
    ...
    mpc.set_nl_cons('P_balance_bounded',(model.u['Power_elect']+model.u['Power_charg'])-model.tvp['Power_solar'] * model.p['Power_solar_MS_par'],0)
    ...
    Power_solar_MS_par_unc_val = np.array([0.8,1,1.2])
    
    mpc.set_uncertainty_values(Power_solar_MS_par=Power_solar_MS_par_unc_val)
