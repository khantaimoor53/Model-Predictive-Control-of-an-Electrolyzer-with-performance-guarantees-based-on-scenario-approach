...
ax[0].axhline(y=90, color='r', linestyle='dashed')
ax[0].axhline(y=20, color='r', linestyle='dashed')
ax[0].set_ylabel('SOC [%]')
ax[5].plot(mpc.data['_time']/(60*60), mpc.data['_aux', 'Current_density'])
ax[5].plot(simulator.data['_time']/(60*60), simulator.data['_aux', 'Current_density'])
ax[5].set_ylabel('J [A/m^2]')
ax[5].axhline(y=5000, color='r', linestyle='dashed')
# ax[0].plot(mpc.data['_time']/(60*60), mpc.data['_aux', 'Power_disca']/1000)
...
ax[6].set_ylabel('P_tank [bar]')
ax[6].axhline(y=400, color='r', linestyle='dashed')
ax[6].axhline(y=1, color='r', linestyle='dashed')

# ax[1].plot(mpc.data['_time']/(60*60), mpc.data['_aux', 'Volt'])
# ax[1].plot(simulator.data['_time']/(60*60), simulator.data['_aux', 'Volt'])
# ax[1].set_ylabel('Volt [V]')
ax[1].plot(mpc.data['_time']/(60*60), mpc.data['_tvp', 'n_dot_demand'])
ax[1].plot(mpc.data['_time']/(60*60), mpc.data['_aux', 'mol_produced'])
ax[1].set_ylabel('Production/ Demand [mol/s]')
